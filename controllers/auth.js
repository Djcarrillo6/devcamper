...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    // If something goes wrong, we can clear out any these fields in the DB 
...
exports.resetPassword = asyncHandler(async (req, res, next) => {
  ...
  // Find a user by their resetToken && their resetPasswordExpire date is greater than Date.now()
